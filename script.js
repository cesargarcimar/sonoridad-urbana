...
agreeBtn.addEventListener('click', () => {
    ...
    userData.Name = nicknameInput.value.trim(); // coincide con la columna exacta
...
fader2.oninput = ()=>{ let v=fader2.value/100; track2a.volume=1-v; track2b.volume=v; userData.spiritual=fader2.value; };
fader3.oninput = ()=>{ let v=fader3.value/100; track3a.volume=1-v; track3b.volume=v; userData.tv=fader3.value; };
fader4.oninput = ()=>{ let v=fader4.value/100; track4a.volume=1-v; track4b.volume=v; userData.market=fader4.value; };
